...
export function ChatSidebar({
  ...
  const { data, isLoading } = useChatList({ mode: Mode.Chat });
  const { mutate, isPending } = useDeleteChat({ mode: Mode.Chat });
  const mutationStates = useChatMutationState({ mode: Mode.Chat });
